# Indice feature concluse

Indice per argomento delle feature concluse (cartella `Completed/`).

## Logging e Monitoraggio
- [logging-e-salvataggio](logging-e-salvataggio/logging-e-salvataggio.md) — logging INFO su file, comando `/log`, metadati MP3, copertina incorporata, Save Srv, errori download visibili
...
<!-- Formato riga: - [nome-feature](nome-feature/nome-feature.md) — argomenti toccati -->
